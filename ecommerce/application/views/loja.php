                ...
                <div class="basic-details">
                    <div class="row clearfix">
                        <div class="image-column col-md-4 col-sm-5 col-xs-12">
                            <figure class="image-box"><a href="assets/images/resource/products/image-12.jpg" class="lightbox-image" title="Image Caption Here"><img src="assets/images/resource/products/image-12.jpg" alt=""></a></figure>
                        </div>
...
<!-------------------------FIM MODAL  PRODUTO----------------------------------->
  ...
  <div style="border:0" style class="inner-box">
      ...
      <div class="lower-content">
          <h3><a href="shop-single.html">Abacaxi</a><spam>(300gr)</spam></h3>
          <div class="price"><span class="price-txt">R$ 18,00</span></div>
      </div>
